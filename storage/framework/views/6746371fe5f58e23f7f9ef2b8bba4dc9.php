...
<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($this->totalPatients()); ?></p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($this->maleCount()); ?></p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($this->femaleCount()); ?></p>
        </div>
    </div>
                    ...
                    <tr class="text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/80">
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none"
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortColumn === 'jenis_pasien'): ?>
                                    <i
                                        class="bi <?php echo e($sortDirection === 'asc' ? 'bi bi-balloon-heart-fill' : 'bi-person-heart'); ?> text-emerald-600"></i>
                                <?php else: ?>
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none" wire:click="sortBy('nik')">
                            <div class="flex items-center gap-1.5">
                                <span>NIK</span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortColumn === 'nik'): ?>
                                    <i
                                        class="bi bi-caret-<?php echo e($sortDirection === 'asc' ? 'up-fill' : 'down-fill'); ?> text-emerald-600"></i>
                                <?php else: ?>
                                    <i class="bi bi-caret-down text-gray-300"></i>
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none"
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortColumn === 'jenis_kelamin'): ?>
                                    <i
                                        class="bi bi-caret-<?php echo e($sortDirection === 'asc' ? 'up-fill' : 'down-fill'); ?> text-emerald-600"></i>
                                <?php else: ?>
                                    <i class="bi bi-caret-down text-gray-300"></i>
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none"
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortColumn === 'tanggal_lahir'): ?>
                                    <i
                                        class="bi bi-caret-<?php echo e($sortDirection === 'asc' ? 'up-fill' : 'down-fill'); ?> text-emerald-600"></i>
                                <?php else: ?>
                                    <i class="bi bi-caret-down text-gray-300"></i>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pasien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="table-row-hover hover:bg-gray-50/60 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        <?php echo e(strtoupper(substr($pasien->nama, 0, 2))); ?>

                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-gray-900 leading-tight">
                                            <?php echo e($pasien->nama); ?></p>
                                        <p class="text-xs text-gray-400 mt-0.5">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pasien->alergi): ?>
                                                <i
                            ...
                            <td class="px-6 py-4">
                                ...
                                <span
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg <?php echo e($colors[0]); ?> <?php echo e($colors[1]); ?> text-xs font-semibold">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600 font-mono"><?php echo e($pasien->nik ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pasien->jenis_kelamin === 'L'): ?>
                                    <span
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2 text-sm text-gray-600">
                                    ...
                                    <span><?php echo e($pasien->no_telpon ?? '-'); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pasien->tanggal_lahir): ?>
                                        <span
                                            class="text-sm text-gray-600"><?php echo e($pasien->tanggal_lahir->format('d M Y')); ?></span>
                                        <span class="text-xs text-gray-400"><?php echo e($pasien->tanggal_lahir->age); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span
                                        class="text-sm text-gray-600"><?php echo e($pasien->created_at->format('d M Y')); ?></span>
                                    <span class="text-xs text-gray-400"><?php echo e($pasien->created_at->format('H:i')); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-1">
                                    <button type="button" wire:click="editing(<?php echo e($pasien->id); ?>)"
                                        class="p-2 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors"
                                        title="Edit">
                                        <i class="bi bi-pencil-square text-lg"></i>
                                    </button>
                                    <button type="button" wire:click="confirmDelete(<?php echo e($pasien->id); ?>)"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($patients->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gray-50/50">
                <p class="text-sm text-gray-500">
                    Menampilkan
                    <span class="font-semibold text-gray-700"><?php echo e($patients->firstItem() ?? 0); ?></span>
                    –
                    <span class="font-semibold text-gray-700"><?php echo e($patients->lastItem()); ?></span>
                    dari
                    <span class="font-semibold text-gray-700"><?php echo e($patients->total()); ?></span>
                    pasien
                </p>
            ...
            <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-bold text-gray-900">
                        <?php echo e($editMode ? 'Edit Data Pasien' : 'Tambah Pasien Baru'); ?>

                    </h2>
                    <p class="text-sm text-gray-500 mt-0.5">
                        <?php echo e($editMode ? 'Perbarui informasi data pasien' : 'Isi data pasien dengan lengkap'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['bayi' => 'Bayi', 'anak-anak' => 'Anak-anak', 'dewasa' => 'Dewasa']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <button type="button" wire:click="$set('jenis_pasien', '<?php echo e($value); ?>')"
                                    class="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl border-2 text-sm font-semibold transition-all
                                        <?php echo e($jenis_pasien === $value
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['jenis_pasien'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['A', 'B', 'AB', 'O', 'A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <button type="button" wire:click="$set('golongan_darah', '<?php echo e($type); ?>')"
                                    class="px-2.5 py-2 rounded-lg border-2 text-xs font-semibold transition-all
                                        <?php echo e($golongan_darah === $type
                                            ? 'border-emerald-500 bg-emerald-50 text-emerald-700'
                                            : 'border-gray-200 text-gray-500 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                    <?php echo e($type); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['golongan_darah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button type="button" wire:click="$set('jenis_kelamin', 'L')"
                                class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 text-sm font-semibold transition-all
                                    <?php echo e($jenis_kelamin === 'L'
                                        ? 'border-blue-500 bg-blue-50 text-blue-700'
                                        : 'border-gray-200 text-gray-500 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                <i
                                    class="bi bi-gender-male <?php echo e($jenis_kelamin === 'L' ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
                                Laki-laki
                            </button>
                            <button type="button" wire:click="$set('jenis_kelamin', 'P')"
                                class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border-2 text-sm font-semibold transition-all
                                    <?php echo e($jenis_kelamin === 'P'
                                        ? 'border-pink-500 bg-pink-50 text-pink-700'
                                        : 'border-gray-200 text-gray-500 hover:border-gray-300 hover:bg-gray-50'); ?>">
                                <i
                                    class="bi bi-gender-female <?php echo e($jenis_kelamin === 'P' ? 'text-pink-500' : 'text-gray-400'); ?>"></i>
                                Perempuan
                            </button>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="alergi" wire:model="alergi" rows="2" placeholder="Tuliskan alergi yang dimiliki (jika ada)"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-900 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all resize-none"></textarea>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['alergi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-end gap-3 bg-gray-50/50">
                ...
                <button type="button" wire:click="save"
                    ...
                    <?php echo e($editMode ? 'Simpan Perubahan' : 'Tambah Pasien'); ?>
...
<?php /**PATH D:\laragon\www\rekam-medis\resources\views/pages/patient/index.blade.php ENDPATH**/ ?>