...
<div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-xl font-bold text-indigo-600 mt-0.5"><?php echo e(number_format($stats['total_periode'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-xl font-bold text-emerald-600 mt-0.5"><?php echo e(number_format($stats['bulan_ini'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Ada Catatan</p>
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['dengan_keterangan'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Ada Pengobatan</p>
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['dengan_pengobatan'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['total_jenis'])); ?></p>
        </div>
    </div>
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none" wire:click="sortBy('tanggal_imunisasi')">
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortColumn === 'tanggal_imunisasi'): ?>
                                    <i class="bi bi-caret-<?php echo e($sortDirection === 'asc' ? 'up-fill' : 'down-fill'); ?> text-indigo-600"></i>
                                <?php else: ?>
                        ...
                        <tr class="table-row-hover hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-600"><?php echo e($r->tanggal_imunisasi->format('d/m/Y')); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->pasien?->jenis_pasien === 'bayi' || ($r->pasien?->tanggal_lahir && \Carbon\Carbon::parse($r->pasien->tanggal_lahir)->age < 2)): ?>
                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded bg-amber-50 text-amber-700 text-[10px] font-bold">Bayi</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <p class="text-xs text-gray-400">
                                        <?php echo e($r->pasien?->tanggal_lahir ? $r->pasien->tanggal_lahir->format('d/m/Y') : ($r->tanggal_lahir_pasien ?: '-')); ?>
                            ...
                            <td class="px-6 py-4 text-center">
                                <?php
                                    ...
                                    $age = $dob ? $dob->age . ' thn' : '-';
                                ?>
                                <span class="text-sm font-semibold text-gray-700"><?php echo e($age); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-md bg-indigo-50 text-indigo-700 text-xs font-semibold">
                                    <i class="bi bi-shield-fill-check mr-1"></i><?php echo e($r->jenis_imunisasi); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-600"><?php echo e($r->nama_orang_tua ?? '-'); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->alamat): ?>
                                        <span class="text-xs text-gray-400"><?php echo e(Str::limit($r->alamat, 40)); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
    ...
    <?php
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
<?php /**PATH D:\laragon\www\rekam-medis\resources\views/pages/immunization/laporan.blade.php ENDPATH**/ ?>