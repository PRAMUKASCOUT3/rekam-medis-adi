...
<div wire:poll.30000>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-xl font-bold text-emerald-600 mt-0.5"><?php echo e(number_format($stats['total_dari_sampai'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Pil</p>
            <p class="text-xl font-bold text-blue-600 mt-0.5"><?php echo e(number_format($stats['total_pil'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Suntik</p>
            <p class="text-xl font-bold text-purple-600 mt-0.5"><?php echo e(number_format($stats['total_suntik'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">IUD</p>
            <p class="text-xl font-bold text-amber-600 mt-0.5"><?php echo e(number_format($stats['total_iud'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Implan</p>
            <p class="text-xl font-bold text-pink-600 mt-0.5"><?php echo e(number_format($stats['total_implan'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Lainnya</p>
            <p class="text-xl font-bold text-orange-600 mt-0.5"><?php echo e(number_format($stats['total_lainnya'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Kunj. Hari Ini</p>
            <p class="text-xl font-bold text-teal-600 mt-0.5"><?php echo e(number_format($stats['kunjungan_hari_ini'])); ?></p>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-[960px]">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="table-row-hover hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-xs font-mono font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg"><?php echo e($r->no_regis); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->umur_istri): ?>
                                        <p class="text-xs text-gray-400"><?php echo e($r->umur_istri); ?> tahun</p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 text-xs font-semibold">
                                    <i class="bi bi-capsule text-[10px]"></i><?php echo e($r->metode_kb); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">
                                    <?php echo e($r->tanggal_kunjungan_ulang ? $r->tanggal_kunjungan_ulang->format('d M Y') : '-'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-xs text-gray-600"><?php echo e($r->user?->name ?? 'N/A'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600"><?php echo e($r->no_hp ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600"><?php echo e(Str::limit($r->alamat, 30) ?? '-'); ?></span>
                            </td>
                        </tr>
...
<?php /**PATH D:\laragon\www\rekam-medis\resources\views/pages/kb/laporan.blade.php ENDPATH**/ ?>