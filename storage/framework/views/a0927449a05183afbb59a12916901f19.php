...
<div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-xl font-bold text-emerald-600 mt-0.5"><?php echo e(number_format($stats['total_periode'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['dengan_keluhan'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Ada Tindakan</p>
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['dengan_tindakan'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Ada Alamat</p>
            <p class="text-2xl font-bold text-rose-500 mt-0.5"><?php echo e(number_format($stats['dengan_alamat'])); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-elevation-sm border border-gray-100">
            <p class="text-xs text-gray-500 font-medium">Ada Pekerjaan</p>
            <p class="text-2xl font-bold text-gray-900 mt-0.5"><?php echo e(number_format($stats['dengan_pekerjaan'])); ?></p>
        </div>
    </div>
                        ...
                        <tr class="table-row-hover hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->pekerjaan_istri): ?>
                                        <p class="text-xs text-gray-400"><?php echo e($r->pekerjaan_istri); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="text-sm text-gray-600">
                                    <?php echo e($r->umur_istri ? $r->umur_istri . ' tahun' : '-'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <span class="text-sm text-gray-600">
                                    <?php echo e($r->umur_suami ? $r->umur_suami . ' tahun' : '-'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600"><?php echo e($r->no_telpon ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600"><?php echo e($r->alamat ?? '-'); ?></span>
                            </td>
                        </tr>
    ...
    <?php
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
<?php /**PATH D:\laragon\www\rekam-medis\resources\views/pages/delivery/laporan.blade.php ENDPATH**/ ?>