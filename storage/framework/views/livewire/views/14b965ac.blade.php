...
<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $this->pilCount() }}</p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-elevation-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $this->suntikCount() }}</p>
        </div>
                    ...
                    <tr class="text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/80">
                        ...
                        <th class="text-left px-6 py-3.5 cursor-pointer select-none" wire:click="sortBy('tanggal_kunjungan_ulang')">
                            <div class="flex items-center gap-1.5">
                                ...
                                @if ($sortColumn === 'tanggal_kunjungan_ulang')
                                    <i class="bi bi-caret-{{ $sortDirection === 'asc' ? 'up-fill' : 'down-fill' }} text-emerald-600"></i>
                                @else
                                    <i class="bi bi-caret-down text-gray-300"></i>
                                @endif
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($records as $record)
                        <tr class="table-row-hover hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-xs font-mono font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg">{{ $record->no_regis }}</span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 text-xs font-semibold">
                                    <i class="bi bi-capsule text-[10px]"></i>{{ $record->metode_kb }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">
                                    {{ $record->tanggal_kunjungan_ulang ? $record->tanggal_kunjungan_ulang->format('d M Y') : '-' }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
            ...
            <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-bold text-gray-900">
                        {{ $editMode ? 'Edit Data KB' : 'Tambah Data KB' }}
                    </h2>
                    <p class="text-sm text-gray-500 mt-0.5">
                        {{ $editMode ? 'Perbarui data KB' : 'Input data KB baru' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div>
                        ...
                        <select id="metode_kb" wire:model="metode_kb" wire:change="autoCalculateKunjunganUlang"
                            ...
                            @foreach ($metodeKbList as $metode)
            ...
            <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gray-50/50">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" wire:click="save"
                        ...
                        {{ $editMode ? 'Simpan Perubahan' : 'Tambah Data KB' }}
                    </button>
                </div>
            </div>
        </div>
